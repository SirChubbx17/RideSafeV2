...
class HistoryAdapter: RecyclerView.Adapter<HistoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.current_loc_list).text = currentItem.start_location
        holder.itemView.findViewById<TextView>(R.id.destination_list).text = currentItem.end_location
